...
// Get the quiz ID from the URL (if editing an existing quiz)
if (isset($_GET['id'])) {
    $quiz_id = $_GET['id'];

    // Fetch existing quiz details from the database using PDO
    ...
    // Redirect to quizzes page if ID is not provided
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Update the quiz in the database using PDO
    $update_sql = "
        UPDATE quizzes 
